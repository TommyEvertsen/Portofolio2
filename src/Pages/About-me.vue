            ...
            <div>
              ...
              <div class="text-body-2 mt-8 about-me-text">
                ...
                <p class="pt-5" style="font-size: large">
                  ...
                  really enjoyed it and developed a passion for it. I decided to
                  make this my daytime job. i sudied the professional front-end
                  development program at Univiersity of California. The teachers
                  there were really skilled and helpful and gave me a lot of
                  feedback on what i could do better and best practices. After i
                  completed the course i got a job as a fullstack developer.
                </p>

                <p class="pt-5" style="font-size: large">
                  I am married to my wonderful wife. Live in Trondheim and i
                  like to have fun and enjoy life
                </p>

                <p class="pt-5" style="font-size: large">
                  My Hobbies include: Camping, fishing, Video games, boardgames,
                  creating videogames in Unity, Hiking, traveling and
                  <span>
